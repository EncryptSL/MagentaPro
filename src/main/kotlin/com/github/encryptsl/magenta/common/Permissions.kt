...
object Permissions {
    ...
    const val CREDIT_SHOP_CATEGORY_ALL = "magenta.credit.shop.category.*"
    ...
    const val SOCIAL_SPY_EXEMPT: String = "magenta.social.spy.exempt"
    ...
    const val WARPS_DELETE_OTHER: String = "magenta.warp.delete.other"
    const val WARPS_MOVE_OTHER: String = "magenta.move.warp.other"
    const val WARPS_RENAME_OTHER: String = "magenta.rename.warp.other"
    ...
    const val VANISH_BLOCK_DAMAGE_BYPASS: String = "magenta.vanish.block.damage.bypass"
